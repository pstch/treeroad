...
admin.site.register_view('graph', graphTaskView, 'Run graphing task', label='Use this to run graphing task for all of the active graphs. This may take some time. You can also run graph tasks individually as actions in the graph list.') #@UndefinedVariable
